...
export const withMask = <T extends object>(WrappedComponent: React.ComponentType<T>) => {
    return forwardRef<HTMLInputElement, T & MaskedInputProps>((props, ref) => {
...
// Componente predefinido con máscara
export const MaskedInput = withMask(Input);